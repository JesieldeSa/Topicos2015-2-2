...
public class TelaJogo extends TelaBase {
    ...
    //variavel usada no metodo detectarcolisao
    private boolean gameOver = false;

    /**
     * Verifica se o Pássaro está envolvido na colisao.
     * @param fixtureA
     * @param fixtureB
     */
    ...
    private void atualizarObstaculos() {
        // enquanto a lista estiver menos do que 4, crie obstáculos
        ...
        for (Obstaculo o : obstaculos){
            //calcula a lateral inicial da cãmera;
    ...
    /**
     * Aualiza a posição do chão para acompanhar o pássaro
     */
